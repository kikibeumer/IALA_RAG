...
# =======================
# Models (ChatmistralAI and MistralAIEmbeddings)
# =======================
...
def build_vector_store():
    ...
    # First-time embedding stored in FAISS
...
# =======================
# Q & A (retrieve relevant docs => context)
# =======================
...
# =======================================
# Streamlit web app running on localhost
# =======================================
...
def main():
    ...
    st.markdown("Ask questions about the IALA documents")
    ...
    # Full reset (including FAISS database)
